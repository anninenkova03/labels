...
**Dependency Injection (DI)** is a design principle used to achieve **Inversion of Control (IoC)**. Instead of a class creating its own dependencies, the dependencies are supplied ("injected") from an external source.
